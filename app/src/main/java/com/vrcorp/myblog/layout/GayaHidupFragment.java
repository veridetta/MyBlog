...
import com.vrcorp.myblog.adapter.GayaHidupAdapter;
...
public class GayaHidupFragment extends Fragment {
    ...
    public GayaHidupFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static GayaHidupFragment newInstance(String param1, String param2) {
        GayaHidupFragment fragment = new GayaHidupFragment();
    ...
    private class GayaHidup extends AsyncTask<Void, Void, Void> {
        @Override
        ...
        protected void onPostExecute(Void result) {
            ...
            GayaHidupAdapter mDataAdapter = new GayaHidupAdapter( getActivity(), judulList, kategoriList,
